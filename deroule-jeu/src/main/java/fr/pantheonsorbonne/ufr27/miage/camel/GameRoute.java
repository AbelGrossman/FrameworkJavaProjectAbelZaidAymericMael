...
//     /*
//      * Le soucis étant que, il faut que durant la partie, a travers GameService
//      * l'interface ou autre,
//      * Je ne sais pas comment cela fonctionne, mais le Camel doit savoir que la
//      * partie est finie
//      */

//     from("direct:endGameA")
//         .log("Partie terminée")
...
//           // creationPartiePayload.put("teamId", INT); // Je n'ai pas trouvé ou il
//           // apparaît
...
//         })
//         .multicast()
//         .to("direct:sendToStatisticsA", "direct:sendToCreationPartieA")
//         .end();

//     // Route pour envoyé vers Maêl (statistiques)
//     /*
//      * Le seul problème étant : comment on peut récupérer le "gameId" pour qu'il
//      * reconnaisse la bonne partie ?
//      * problème réglé ! On transmet le gameId dans les headers
//      */
//     from("direct:sendToStatisticsA")
//         .process(exchange -> {
...
//     from("direct:sendToCreationPartieA")
//         .process(exchange -> {
