...
public class GameDAOImpl implements GameDAO {
    ...
    //     List<Game> games = entityManager.createQuery("SELECT g FROM Game g WHERE g.theme = :theme", Game.class)
    ...
    // @Override
    // @Transactional
    // public void savePlayerResults(String playerId, String gameId, int score, long averageResponseTime) {
    //     PlayerResult playerResult = new PlayerResult(playerId, gameId, score, averageResponseTime);
    //     entityManager.persist(playerResult);
    //     logger.info("Player results saved for player ID: {} in game ID: {}", playerId, gameId);
    // }
}